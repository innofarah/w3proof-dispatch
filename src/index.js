...
const { mainInterface, setweb3token, setgateway, setAbellaExecutable, listconfig, keygen, publishSigned } = require('./publish.js')
...
program
    .command('set-abella-executable <path>')
    .description('set the path for the abella executable. the expected argument is for example: /fullpath/abella.exe')
    .action(setAbellaExecutable)
